    ...
    return (
        ...
        >
            <div className="projects__navbar">
                ...
                <div className={active === 'node' && 'projects__navbar-active'} onClick={() => handleFilterCategory('node')}>Node</div>
                <div className={active === 'vanilla' && 'projects__navbar-active'} onClick={() => handleFilterCategory('vanilla')}>Vanila</div>
            </div>
            <div className="row">
              {
